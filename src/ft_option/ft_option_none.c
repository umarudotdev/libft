 ...
 *
 * This function constructs an Option that contains no value.
 * This represents the absence of a value in a type-safe way,
 * avoiding the need for NULL pointer checks.
 *
