 ...
 *
 * This function constructs an Option that contains a value.
 * The value can be any pointer type. Note that passing NULL
 * will create a Some(NULL), which is different from None.
 *
