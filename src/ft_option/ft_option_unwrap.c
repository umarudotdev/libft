 ...
 *
 * This function returns the contained Some value. If the Option is None,
 * it calls ft_panic to terminate the program. This should only be used
 * when you are certain the Option is Some, or when a panic is acceptable.
 *
