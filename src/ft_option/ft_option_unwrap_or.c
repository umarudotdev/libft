 ...
 *
 * This function safely extracts the value from an Option. If the Option
 * is Some, it returns the contained value. If the Option is None, it returns
 * the provided default value instead. This is a safe alternative to unwrap.
 *
 ...
 */
void	*ft_option_unwrap_or(t_option option, void *default_value)
{
	if (option.is_some)
		return (option.value);
