 ...
 *
 * This function returns the contained Ok value if the Result is Ok,
 * or the provided default value if the Result is Err. This is a safe
 * way to extract values without risking a panic.
 *
 ...
 */
void	*ft_result_unwrap_or(t_result result, void *default_value)
{
	if (result.is_ok)
