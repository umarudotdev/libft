 ...
 *
 * This function returns the contained Err value. If the Result is Ok,
 * it calls ft_panic to terminate the program. This is useful for
 * extracting error information when you know the operation failed.
 *
