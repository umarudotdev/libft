 ...
 *
 * This function tests whether a Result contains a successful value.
 * It's the primary way to determine if an operation succeeded before
 * attempting to extract the value.
 *
