 ...
 *
 * This function constructs a failed Result that contains an error value.
 * The error can be any pointer type, such as an error message string,
 * error code, or custom error structure.
 *
