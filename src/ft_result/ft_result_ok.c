 ...
 *
 * This function constructs a successful Result that contains a value.
 * The value can be any pointer type, including NULL for functions that
 * don't return meaningful values but can still fail.
 *
